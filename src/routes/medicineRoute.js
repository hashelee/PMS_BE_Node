...
import { createMedicine, deleteMedicine, editMedicine, getMedicineById, getPharmaciesByMedicine } from "../controllers/medicineController.js";
...
router.get("/search", authenticateUser, getPharmaciesByMedicine);
